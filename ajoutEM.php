...
<div class="form-box">
    <div class="warning">
                <span><img class="favicon" src="warning.png"/>Ne sont pas concernés les événements indésirables consécutifs à la
                    prise d'un médicament, ceci relevant de la pharmacovigilance</span>
    </div>
    <form method="POST" action="">
        <!-- Identité de la personne qui déclare -->
        <h2>Identité</h2>
        <div id="anonym" class="sectionForm">
        ...
        <div id="idDeclareForm" class="idForm">
        ...
        <div class="md-auto">
            <div class="md-auto">
                ...
                <label for="Non">Non</label>
                <input type="radio" id="administration_risque" name="administration_risque" value="Je ne sais pas"
                       required>
                <label for="Jenesaispas">Je ne sais pas</label>
            </div>
            <!-- Précisions -->
        ...
        <div class="md-auto">
            ...
            <input type="radio" id="degre_realisation" name="degre_realisation" value="EM a atteint le patient"
                   required>
            ...
            <input type="radio" id="degre_realisation" name="degre_realisation"
                   value="Evénement porteur de risque (EPR)" required>
        ...
        <div class="row justify-content-center">
            <div class="ajouter"><p>Attention, toute validation est définitive</p><input class="btn btn-outline-primary"
                                                                                         type="submit"
                                                                                         value="Valider la déclaration"
                                                                                         name="nouvelEvenement"></div>
        </div>
    </form>
</div>
</body>
